...
import { extrairResumo } from '@/lib/site/markdown'
        ...
        {artigos.length === 0 ? (
          ...
          artigos.map(a => (
            ...
            >
              ...
              <p className="mt-2 text-sm text-dipallacio-navy-800/70">{extrairResumo(a.conteudoMarkdown, 140)}</p>
              <p className="mt-3 text-xs uppercase tracking-wide text-dipallacio-navy-800/50">
